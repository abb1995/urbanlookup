import requests, argparse, json, textwrap
...
def print_defs(result, num): #Print information about the words
	...
	for i in range(0, num): #This will print "args.num" definitions
		#Prettify
		print('Word:\n\n\t', end='')
		print(textwrap.fill(result['list'][i]['word'], 70, initial_indent='', subsequent_indent='\t'))
		print()
		print('Author:\n\n\t', end='')
		print(textwrap.fill(result['list'][i]['author'], 70, initial_indent='', subsequent_indent='\t'))
		print()
		print('Definition:\n\n', end='')
		print(textwrap.fill(result['list'][i]['definition'], 70, initial_indent='', subsequent_indent='\t'))
		print()
		print('Example:\n\n\t', end='')
		print(textwrap.fill(result['list'][i]['example'], 70, initial_indent='', subsequent_indent='\t'))
		print()
